...
export default function Admins() {
  const demoAdmins = [
    { _id: "1", name: "Super Admin", email: "super@admin.com" },
    { _id: "2", name: "Manager Admin", email: "manager@admin.com" },
    { _id: "3", name: "Support Admin", email: "support@admin.com" },
  ];

  const [adminData, setAdminData] = useState(demoAdmins);
  ...
  const handleRemove = (id) => {
    fetch(`http://localhost:5000/all-admins/${id}`, {
      ...
      .then(() => {
        ...
        setAdminData(adminData.filter((a) => a._id !== id));
      })
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold dark:text-white">Admins</h2>
        <button
